...
(NOMPRO, MARPRO, FAMPRO, DESPRO, PREPRO, ESTPRO)
VALUES
('Doritos', 'Doritos', 'Snacks', 'Doritos sabor queso', '3.50', 'A'),
('Aceite', 'Primor', 'Abarrotes', 'Aceite de cocina', '5.50', 'A'),
('Arroz', 'Tondero', 'Abarrotes', 'Arroz blanco', '4.50', 'A'),
('Azúcar', 'Dulfina', 'Desayunos', 'Azúcar morena', '3.50', 'A'),
('Gaseosa', 'Coca cola', 'Bebidas', 'Gaseosa sin azúcar', '9.00', 'A'),
('Gaseosa', 'Inka cola', 'Bebidas', 'Gaseosa sabor original', '9.50', 'A'),
('Galleta', 'Picaras', 'Dulces', 'Galleta Sabor fresa', '1.50', 'A'),
('Chocolate', 'Vizzio', 'Dulces', 'Chocolate con almendras', '4.00', 'A'),
('Mantequilla', 'Manty', 'Lácteos', 'Mantequilla clásica', '3.50', 'A'),
('Yogurt', 'Gloria', 'Lácteos', 'Yogurt sabor fresa', '7.00', 'A');
GO
